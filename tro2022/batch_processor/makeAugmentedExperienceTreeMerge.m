function [descs_list, invkeys_list, xy_poses] = makeAugmentedExperienceTreeMerge(testinfo, SKIP_FRAMES)
...
%         xlim([-80, 80]); ylim([-80, 80]); zlim([-5, 20]);
    ...
    if( strcmp(testinfo.method_, 'pc') )
        ...
        desc_list = ptcloud2polarcontextAug(ptcloud, num_sector, num_ring, max_range); % up to 80 meter
